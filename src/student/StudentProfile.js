            ...
            <div className="md:flex no-wrap md:-mx-2 ">
                ...
                <div className="w-full md:w-3/12 md:mx-2">
                    ...
                    <div className="bg-white p-3 border-t-4 border-dark-blue">
                        ...
                        <h1 className="text-gray-900 font-bold text-xl leading-8 my-1">Kadir Ozer Ozturk</h1>
                        ...
                        <div className="text-gray-700">
                            <div className="grid md:grid-cols-2 text-sm">
                                <div className="grid grid-cols-2">
                                    ...
                                    <div className="px-4 py-2">Kadir Ozer</div>
                                </div>
                                <div className="grid grid-cols-2">
                                    <div className="px-4 py-2 font-semibold">Soyisim</div>
                                    <div className="px-4 py-2">Ozturk</div>
                                </div>
                                <div className="grid grid-cols-2">
                                ...
                                <div className="grid grid-cols-2">
                                    ...
                                    <div className="px-4 py-2">+90 (545) 657 77 27</div>
                                </div>
                                <div className="grid grid-cols-2">
                                    <div className="px-4 py-2 font-semibold">Address</div>
                                    <div className="px-4 py-2">Cankaya/Ankara </div>
                                </div>
                                <div className="grid grid-cols-2">
                                ...
                                <div className="grid grid-cols-2">
                                    ...
                                    <div className="px-4 py-2">
                                        <a className="text-blue-800" href="mailto:jane@example.com">ozturkkadirozer@gmail.com</a>
                                    </div>
                                </div>
                                <div className="grid grid-cols-2">
